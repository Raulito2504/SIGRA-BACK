    ...
    static async create(contratoData) {
        try {
            const [result] = await pool.execute(
                ...
                (num_contrato, dias, lugar_expedicion, fecha_expedicion, fecha_vencimiento, monto_total, monto_anticipo, id_tipo_contrato, id_cliente, id_vehiculo, id_usuario)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
                [
                    contratoData.num_contrato,
                    contratoData.dias,
                    contratoData.lugar_expedicion,
                    contratoData.fecha_expedicion,
                    contratoData.fecha_vencimiento,
                    contratoData.monto_total,
                    contratoData.monto_anticipo,
                    contratoData.id_tipo_contrato,
